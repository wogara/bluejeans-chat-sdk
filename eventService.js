    ...
    var EventService = my.Class(
    {
        ...
        setUpSocket: function(options, reconnect_count)
        {
            ...
            sock.onmessage = function(_e)
            {
                ...
                try
				{
					console.log("Received a msg: " + JSON.stringify(msg,null,2));
					if ((msg.length == 2) && (typeof msg[1] === 'object'))
                    {
                        ...
                        switch(evt)
                        {
                            ...
                            default:
								var evt_data = msg[1];
                                //Check for reqId for Request / Response model
                ...
                catch (e)
                {
                    ...
                    console.log("Error: Invalid JSON this from SockJS - " + JSON.stringify(e));
                    console.log(e);
                }
            };
